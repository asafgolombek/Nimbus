...
- [ ] **Settings** — model selection (cloud vs local) · sync intervals per connector · ~~profile switcher~~ ✅ (Plan 2) · Vault key listing (no values shown) · audit log viewer + export · data export/import · ~~telemetry toggle~~ ✅ (Plan 2) — Plans 3–5 complete remaining panels
