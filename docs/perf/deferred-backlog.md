...
Misses 6–N — picked up by **B2-v2 (post-`v0.1.0`)** per Phase 4 perf audit design §11. Each row carries `Confidence` (mirrors B1) so retained-Low items are visibly flagged here rather than silently mixed into the top-5.
