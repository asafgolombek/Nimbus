...
| WS7 — VS Code Extension | `packages/vscode-extension/`; `@nimbus-dev/client`-based IPC; streaming Ask Webview; Search + Run Workflow commands; HITL routing; status bar; published to Marketplace + Open VSX |
