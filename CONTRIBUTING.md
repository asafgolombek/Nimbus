...
Thank you for your interest in contributing. Nimbus is in active early development (Q1 2026 — Foundation phase). Architecture is stabilising but not all interfaces are frozen.

Before writing any code, read the two documents that define what Nimbus is:
