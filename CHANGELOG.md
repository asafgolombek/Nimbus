...
## [7.17.0](https://github.com/nimbus-agent/Nimbus/compare/v7.16.0...v7.17.0) (2026-09-10)


### Features

* **cli:** nimbus index health — index quality, not index size ([#1483](https://github.com/nimbus-agent/Nimbus/issues/1483)) ([93ac016](https://github.com/nimbus-agent/Nimbus/commit/93ac016d5a564f633732c4ba8f2eb6beb4bdb049))
...
* close three documented gaps in completed phases (I16 reasons, connector.startAuth, redaction fixtures) ([#1480](https://github.com/nimbus-agent/Nimbus/issues/1480)) ([da5d239](https://github.com/nimbus-agent/Nimbus/commit/da5d2399eae49412d82d4f2be94be1b2c50c7d25))

## [7.15.0](https://github.com/nimbus-agent/Nimbus/compare/v7.14.0...v7.15.0) (2026-09-09)


### Features

* **toolgen:** runtime tool generation PR 1 of 3 — the sandboxed substrate ([#1475](https://github.com/nimbus-agent/Nimbus/issues/1475)) ([4719bfb](https://github.com/nimbus-agent/Nimbus/commit/4719bfb1aaa1febd3ed0b68c180398714f121eea))

## [7.14.0](https://github.com/nimbus-agent/Nimbus/compare/v7.13.0...v7.14.0) (2026-09-08)


### Features

* **fleet:** add the overnight-fleet change digest (PR 2a) ([#1467](https://github.com/nimbus-agent/Nimbus/issues/1467)) ([4c54be8](https://github.com/nimbus-agent/Nimbus/commit/4c54be81e5363246037c5ccdd1928ff706611776))


### Bug Fixes

* **deps:** unbreak main — move the override pins [#1469](https://github.com/nimbus-agent/Nimbus/issues/1469) outgrew, and restore the docs build ([#1474](https://github.com/nimbus-agent/Nimbus/issues/1474)) ([2cc6fcf](https://github.com/nimbus-agent/Nimbus/commit/2cc6fcf0870629919ee83110681a44503f2a674d))

## [7.13.0](https://github.com/nimbus-agent/Nimbus/compare/v7.12.0...v7.13.0) (2026-09-07)


### Features

* **http:** GET /v1/items/resolve-ids — an item id back to its reference ([#1465](https://github.com/nimbus-agent/Nimbus/issues/1465)) ([8531752](https://github.com/nimbus-agent/Nimbus/commit/8531752330d23551738d815e9f6e2d6d72e75f77))
...
* **fleet:** close the five follow-ups from the overnight-fleet merge ([#1462](https://github.com/nimbus-agent/Nimbus/issues/1462)) ([bf0559b](https://github.com/nimbus-agent/Nimbus/commit/bf0559b56c52ab79c9c48e94fd1d2ce1e649aa67))
...
* **http:** resolve a forge file coordinate to a path in the reader's checkout ([#1447](https://github.com/nimbus-agent/Nimbus/issues/1447)) ([b472f67](https://github.com/nimbus-agent/Nimbus/commit/b472f67988de1f7ef16577e47da57f7c42f7e7db))
* **multimodal:** cloud byte-fetch for Photos, Drive and OneDrive (S2 PR 3 of 4) ([#1448](https://github.com/nimbus-agent/Nimbus/issues/1448)) ([3f7e7b6](https://github.com/nimbus-agent/Nimbus/commit/3f7e7b62668387cf61b40ff0a3ddcc6bf6cf69e9))
...
* **ci:** the sdk release-train tagPattern never matched a real tag, and that only warned ([#1445](https://github.com/nimbus-agent/Nimbus/issues/1445)) ([19a371c](https://github.com/nimbus-agent/Nimbus/commit/19a371c3d9e6251a208e2c20655204b44d59e6cc))
...
* **exec:** sandboxed code execution behind the I33 owner gate (S2 slice 1) ([#1313](https://github.com/nimbus-agent/Nimbus/issues/1313)) ([25e2c3b](https://github.com/nimbus-agent/Nimbus/commit/25e2c3bdf8ba9b8718cf24994a31bffc36745899))
...
* the remaining 24 findings from the local-LLM audit ([#1307](https://github.com/nimbus-agent/Nimbus/issues/1307)) ([1f9ae09](https://github.com/nimbus-agent/Nimbus/commit/1f9ae09a1a27401de96241686e9b97868309b969))

## [2.13.2](https://github.com/nimbus-agent/Nimbus/compare/v2.13.1...v2.13.2) (2026-08-22)


### Bug Fixes

* **cli:** a Gateway connection can always answer a HITL prompt ([#1305](https://github.com/nimbus-agent/Nimbus/issues/1305)) ([576ba6e](https://github.com/nimbus-agent/Nimbus/commit/576ba6e2d7d5fb4ea0cd8d81d0505b4c57f4f085))

## [2.13.1](https://github.com/nimbus-agent/Nimbus/compare/v2.13.0...v2.13.1) (2026-08-22)


### Bug Fixes

* **agents:** strip a fabricated reserved section at any level, and in its non-heading form ([#1302](https://github.com/nimbus-agent/Nimbus/issues/1302)) ([6742411](https://github.com/nimbus-agent/Nimbus/commit/6742411706b8c41b3730f93e91ba45bd5129fd75))
* **build:** bundle the gateway workers so they exist in a compiled binary ([#1299](https://github.com/nimbus-agent/Nimbus/issues/1299)) ([934779b](https://github.com/nimbus-agent/Nimbus/commit/934779b29fcab02a7d234402e949a14b80264a92))
* **ci:** close the pre-push gaps behind most red PR checks ([#1303](https://github.com/nimbus-agent/Nimbus/issues/1303)) ([0407fb0](https://github.com/nimbus-agent/Nimbus/commit/0407fb0c1410a15435c3e170b113a6163db8518e))
* **ci:** make the sandbox spawn suite report why it failed, and gate it on the platforms it is about ([#1298](https://github.com/nimbus-agent/Nimbus/issues/1298)) ([344e217](https://github.com/nimbus-agent/Nimbus/commit/344e2173300bec92886d7f329ba6fe220360c234))
* **preflight:** an unknown service must not pass the deploy gate ([#1297](https://github.com/nimbus-agent/Nimbus/issues/1297)) ([6ae5a53](https://github.com/nimbus-agent/Nimbus/commit/6ae5a53fd3ca911373ca511dafa5ad48e29f1d69))
...
* **security:** I32 — clip source metadata is whitelist-constructed, so a page cannot deny ingestion of its own clip ([#1288](https://github.com/nimbus-agent/Nimbus/issues/1288)) ([5587c84](https://github.com/nimbus-agent/Nimbus/commit/5587c84e55eff015ea508a423fb7365e14ce94f9))

## [2.11.0](https://github.com/nimbus-agent/Nimbus/compare/v2.10.0...v2.11.0) (2026-08-21)


### Features

* **clips:** a web clip can say who wrote it — optional source metadata on POST /v1/clips (2.5 S2) ([#1285](https://github.com/nimbus-agent/Nimbus/issues/1285)) ([1c7e818](https://github.com/nimbus-agent/Nimbus/commit/1c7e8184e04acf8b1eaddf6415e52fbda46b2001))

## [2.10.0](https://github.com/nimbus-agent/Nimbus/compare/v2.9.0...v2.10.0) (2026-08-21)


### Features

* **engine:** negation predicates reach nimbus ask and MCP clients, refusing rather than guessing (W6-B.2) ([#1281](https://github.com/nimbus-agent/Nimbus/issues/1281)) ([5ce7505](https://github.com/nimbus-agent/Nimbus/commit/5ce7505be84d5cc3e5c0f36e96dae6872c1102b0))
...
* **prfiles:** index PR changed-file paths behind an explicit coverage record ([#1258](https://github.com/nimbus-agent/Nimbus/issues/1258)) ([926fb80](https://github.com/nimbus-agent/Nimbus/commit/926fb80fd4f04515c6f92ef8aca40a0986746df4))
...
* **agents:** give every interleaved brief disclosure one definition and a guard ([#1245](https://github.com/nimbus-agent/Nimbus/issues/1245)) ([5b9c115](https://github.com/nimbus-agent/Nimbus/commit/5b9c1152c6c0df19f0035ab401bd62413132b89b))
* **agents:** never let synthesis drop a brief's disclosures ([#1237](https://github.com/nimbus-agent/Nimbus/issues/1237)) ([f27b416](https://github.com/nimbus-agent/Nimbus/commit/f27b416b793fc096f59e73196a3b1717ca7e8764))


### Bug Fixes

* **release:** parse the squash message GitHub actually creates ([#1235](https://github.com/nimbus-agent/Nimbus/issues/1235)) ([044c16b](https://github.com/nimbus-agent/Nimbus/commit/044c16bd36b4aa06716a917d6a6e412ef9c8ef80))

## [2.5.0](https://github.com/nimbus-agent/Nimbus/compare/v2.4.9...v2.5.0) (2026-08-16)


### Features

* **clips:** related answers about the resolved item, and its snippets come from the body ([#1232](https://github.com/nimbus-agent/Nimbus/issues/1232)) ([9f75fa3](https://github.com/nimbus-agent/Nimbus/commit/9f75fa3fe8c75a740ff86dbea09b8d80cca427b3))
...
* **release:** gate the release PR at PR time, and reject a body release-please cannot parse ([#1227](https://github.com/nimbus-agent/Nimbus/issues/1227)) ([074daab](https://github.com/nimbus-agent/Nimbus/commit/074daab8d22b28212b4a8fd467d3783b76678e35))

## [2.4.7](https://github.com/nimbus-agent/Nimbus/compare/v2.4.6...v2.4.7) (2026-08-16)


### Bug Fixes

* **security:** three allowlisted methods had no reachable handler; add the test I7 promised ([#1225](https://github.com/nimbus-agent/Nimbus/issues/1225)) ([f7d8c75](https://github.com/nimbus-agent/Nimbus/commit/f7d8c75cdd893a0cabd596f3792fc5aa05c43d05))
